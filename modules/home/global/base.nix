{
  # Cross-platform home-manager base: xdg, state version, and the active Stylix
  # color scheme. Applied to every home configuration (mac and linux).
  flake.homeModules.global-base =
    { ... }:
    {
      xdg.enable = true;
