...

{
  ...
  programs.zsh.shellAliases = {
    dr = "sudo darwin-rebuild --impure switch --flake ~/dotfiles/darwin#work --option warn-dirty false";
    hms = "home-manager switch --flake ~/dotfiles/home-manager#scott-mac-work --option warn-dirty false";
  };
